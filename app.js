...
var BlogModel = new mongoose.model("Post", blogPostSchema);

app.get("/", function(req, res) {
	const posts = BlogModel.find({}, function(err, posts) {
...
app.get("/posts/:postTitle", function(req, res) {
	BlogModel.findOne(
		{ link: _.lowerCase(req.params.postTitle).replace(/ /g, "-") },
		function(err, post) {
...
app.post("/", function(req, res) {
	const newPost = new BlogModel({
		...
		link: _.lowerCase(req.body.postTitle).replace(/ /g, "-")
	});
	newPost.save();
	res.redirect("/");
});
